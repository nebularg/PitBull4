...
friend_buffs.DEATHKNIGHT = {
	...
	[55610]  = not legion_700, -- Unholy Aura
}
...
self_buffs.DEATHKNIGHT = {
	...
	[114851] = not legion_700, -- Blood Charge (Blood Tap)
	[49222]  = not legion_700, -- Bone Shield
	[119975] = true, -- Conversion
	[81141]  = true, -- Crimson Scourge
	[49028]  = true, -- Dancing Rune Weapon
	[101568] = true, -- Dark Succor
	[96268]  = not legion_700, -- Death's Advance
	[115018] = true, -- Desecrated Ground
	[59052]  = true, -- Freezing Fog (Rime)
	[48266]  = not legion_700, -- Frost Presence
	[48792]  = true, -- Icebound Fortitude
	[51124]  = true, -- Killing Machine
	[49039]  = true, -- Lichborne
	[51271]  = true, -- Pillar of Frost
	[50421]  = not legion_700, -- Scent of Blood
	[91342]  = not legion_700, -- Shadow Infusion
	[114868] = not legion_700, -- Soul Reaper
...
self_debuffs.DEATHKNIGHT = {
	...
	[157335] = not legion_700, -- Will of the Necropolis
}
...
enemy_debuffs.DEATHKNIGHT = {
	...
	[50435]  = not legion_700, -- Chilblains
	...
	[91800]  = true, -- Gnaw
	[155159] = not legion_700, -- Necrotic Plague
	[108200] = not legion_700, -- Remorseless Winter
	[47476]  = true, -- Strangulate
	[130735] = not legion_700, -- Soul Reaper
...
friend_buffs.DRUID = {
	...
	[17007]  = not legion_700, -- Leader of the Pack
	[33763]  = true, -- Lifebloom
	[48504]  = true, -- Living Seed
	[1126]   = not legion_700, -- Mark of the Wild
	[24907]  = not legion_700, -- Moonkin Aura
	[8936]   = true, -- Regrowth
...
self_buffs.DRUID = {
	...
	[127663] = not legion_700, -- Astral Communion
	[22812]  = true, -- Barkskin
	[50334]  = not legion_700, -- Berserk
	[5487]   = true, -- Bear Form
	[768]    = true, -- Cat Form
	[112071] = not legion_700, -- Celestial Alignment
	[16870]  = true, -- Clearcasting
	[1850]   = true, -- Dash
	[33943]  = true, -- Flight Form
	[22842]  = true, -- Frenzied Regeneration
	[96206]  = not legion_700, -- Glyph of Rejuvenation
	...
	[16188]  = not legion_700, -- Nature's Swiftness
	[69369]  = true, -- Predator's Swiftness
	[5215]   = true, -- Prowl
	[62606]  = not legion_700, -- Savage Defense
	[52610]  = true, -- Savage Roar
	[93400]  = not legion_700, -- Shooting Stars
	[48505]  = not legion_700, -- Starfall
	[61336]  = true, -- Survival Instincts
	[40120]  = true, -- Swift Flight Form
	[5217]   = true, -- Tiger's Fury
	[135286] = not legion_700, -- Tooth and Claw
...
pet_buffs.DRUID = {}
enemy_debuffs.DRUID = {
	[106996] = not legion_700, -- Astral Storm
	[5211]   = true, -- Bash
	[33786]  = true, -- Cyclone
	[99]     = true, -- Demoralizing Roar
	[339]    = true, -- Entangling Roots
	[770]    = not legion_700, -- Faerie Fire
	[102355] = not legion_700, -- Faerie Swarm
	...
	[1822]   = true, -- Rake
	[1079]   = true, -- Rip
	[2908]   = not legion_700, -- Soothe Animal
...
friend_buffs.HUNTER = {
	...
	[13159]  = not legion_700, -- Aspect of the Pack
	[34477]  = true, -- Misdirection
	[160452] = true, -- Netherwinds
	[53480]  = true, -- Roar of Sacrifice
	[109212] = not legion_700, -- Spirit Bond
	[90361]  = true, -- Spirit Mend
	[19506]  = not legion_700, -- Trueshot Aura
	-- pet group buffs
	[159988] = not legion_700, -- Bark of the Wild
	[97229]  = not legion_700, -- Bellowing Roar
	[160017] = not legion_700, -- Blessing of Kongs
	[24844]  = not legion_700, -- Breath of the Winds
	[128432] = not legion_700, -- Cackling Howl
	[50518]  = not legion_700, -- Chitinous Armor
	[160045] = not legion_700, -- Defensive Quills
	[58604]  = not legion_700, -- Double Bite
	[159736] = not legion_700, -- Duality
	[90363]  = not legion_700, -- Embrace of the Shale Spider
	[135678] = not legion_700, -- Energizing Spores
	[126373] = not legion_700, -- Fearless Roar
	[24604]  = not legion_700, -- Furious Howl
	[173035] = not legion_700, -- Grace
	[35290]  = not legion_700, -- Indomitable
	[160039] = not legion_700, -- Keen Senses
	[160073] = not legion_700, -- Plainswalking
	[90364]  = not legion_700, -- Qiraji Fortitude
	[93435]  = not legion_700, -- Roar of Courage
	[160003] = not legion_700, -- Savage Vigor
	[128433] = not legion_700, -- Serpent's Cunning
	[160074] = not legion_700, -- Speed of the Swarm
	[128997] = not legion_700, -- Spirit Beast Blessing
	[34889]  = not legion_700, -- Spry Attacks
	[126309] = not legion_700, -- Still Water
	[160077] = not legion_700, -- Strength of the Earth
	[160052] = not legion_700, -- Strength of the Pack
	[160014] = not legion_700, -- Sturdiness
	[159735] = not legion_700, -- Tenacity
	[90309]  = not legion_700, -- Terrifying Roar
	[57386]  = not legion_700, -- Wild Strength
}
...
self_buffs.HUNTER = {
	...
	[5118]   = not legion_700, -- Aspect of the Cheetah
	[82921]  = true, -- Bombardment
	[51753]  = not legion_700, -- Camouflage
	[19263]  = true, -- Deterrence
	[6197]   = true, -- Eagle Eye
	[82692]  = not legion_700, -- Focus Fire
	...
	[34720]  = not legion_700, -- Thrill of the Hunt
...
pet_buffs.HUNTER = {
	...
	[53479]  = not legion_700, -- Last Stand
...
enemy_debuffs.HUNTER = {
	...
	[3674]   = not legion_700, -- Black Arrow
	[5116]   = true, -- Concussive Shot
	[20736]  = true, -- Distracting Shot
	[64803]  = true, -- Entrapment
	[53301]  = not legion_700, -- Explosive Shot
...
-- MAGE
friend_buffs.MAGE = {
	[1459]   = not legion_700, -- Arcane Brilliance
	[61316]  = not legion_700, -- Dalaran Brilliance
	[130]    = true, -- Slow Fall
...
self_buffs.MAGE = {
	...
	[57761]  = not legion_700, -- Brain Freeze
	...
	[111264] = not legion_700, -- Ice Ward
	[12472]  = true, -- Icy Veins
	[157610] = not legion_700, -- Improved Blink
	[157633] = not legion_700, -- Improved Scorch
	[116267] = true, -- Incanter's Flow
	[66]     = true, -- Invisibility
	[6117]   = true, -- Mage Armor
	[55342]  = true, -- Mirror Image
	[30482]  = true, -- Molten Armor
	[12043]  = not legion_700, -- Presence of Mind
	[46989]  = not legion_700, -- Rapid Teleportation (Glyph of)
...
pet_buffs.MAGE = {}
enemy_debuffs.MAGE = {
	[10]     = not legion_700, -- Blizzard
	[6136]   = true, -- Chilled (Frost Armor)
	[11129]  = not legion_700, -- Combustion
	[120]    = true, -- Cone of Cold
	[44572]  = not legion_700, -- Deep Freeze
	...
	[102051] = not legion_700, -- Frostjaw
...
friend_buffs.PALADIN = {
	...
	[157007] = not legion_700, -- Beacon of Insight
	[20217]  = not legion_700, -- Blessing of Kings
	[19740]  = not legion_700, -- Blessing of Might
	[31821]  = true, -- Devotion Aura
	[114163] = true, -- Eternal Flame
	[54957]  = not legion_700, -- Glyph of Flash of Light
	[1044]   = true, -- Hand of Freedom
	[1022]   = true, -- Hand of Protection
	[114039] = not legion_700, -- Hand of Purity
	[6940]   = true, -- Hand of Sacrifice
	[1038]   = not legion_700, -- Hand of Salvation
	[105809] = true, -- Holy Avenger
	[86273]  = not legion_700, -- Illuminated Healing
	[20925]  = not legion_700, -- Sacred Shield
	[157128] = not legion_700, -- Saved by the Light
	[152262] = true, -- Seraphim
	[114917] = not legion_700, -- Stay of Execution
}
friend_debuffs.PALADIN = {
	[25771]  = true, -- Forbearance
	[157131] = not legion_700, -- Recently Saved by the Light
}
self_buffs.PALADIN = {
	[31850]  = true, -- Ardent Defender
	[31842]  = true, -- Avenging Wrath (Holy)
	[31884]  = true, -- Avenging Wrath (Retribution)
	[114637] = not legion_700, -- Bastion of Glory
	[121183] = true, -- Contemplation
	[88819]  = not legion_700, -- Daybreak
	[498]    = true, -- Divine Protection
	[90174]  = not legion_700, -- Divine Purpose
	...
	[121027] = not legion_700, -- Glyph of Double Jeopardy
	[115522] = not legion_700, -- Glyph of Word of Glory
	[115668] = not legion_700, -- Glyph of Templar's Verdict
	...
	[105361] = not legion_700, -- Seal of Command
	[20164]  = not legion_700, -- Seal of Justice
	[20165]  = not legion_700, -- Seal of Insight
	[20154]  = not legion_700, -- Seal of Righteousness
	[31801]  = not legion_700, -- Seal of Truth
...
enemy_debuffs.PALADIN = {
	...
	[31803]  = not legion_700, -- Censure (Seal of Truth)
	[26573]  = true, -- Consecration
	[63529]  = not legion_700, -- Dazed - Avenger's Shield
	[2812]   = not legion_700, -- Denounce
	[114916] = not legion_700, -- Execution Sentence
	[105593] = not legion_700, -- Fist of Justice
	[853]    = true, -- Hammer of Justice
	[119072] = not legion_700, -- Holy Wrath
	[20066]  = true, -- Repentance
	[10326]  = not legion_700, -- Turn Evil
}
...
friend_buffs.PRIEST = {
	...
	[47753]  = not legion_700, -- Divine Aegis
	[64843]  = true, -- Divine Hymn
	[77489]  = true, -- Echo of Light
	[157146] = not legion_700, -- Enhanced Leap of Faith
	[6346]   = not legion_700, -- Fear Ward
	[47788]  = true, -- Guardian Spirit
	[1706]   = true, -- Levitate
	[7001]   = not legion_700, -- Lightwell Renew
	[49868]  = not legion_700, -- Mind Quickening
	[81782]  = true, -- Power Word: Barrier
	[21562]  = not legion_700, -- Power Word: Fortitude
	[17]     = true, -- Power Word: Shield
	[123258] = true, -- Power Word: Shield (Divine Insight)
	[21562]  = not legion_700, -- Prayer of Fortitude
	[33206]  = true, -- Pain Suppression
	[41635]  = true, -- Prayer of Mending
	[123262] = not legion_700, -- Prayer of Mending (Divine Insight)
	[139]    = true, -- Renew
}
...
self_buffs.PRIEST = {
	[114214] = not legion_700, -- Angelic Bulwark
	[81700]  = not legion_700, -- Archangel
	[65081]  = true, -- Body and Soul
	[59889]  = not legion_700, -- Borrowed Time
	[81209]  = not legion_700, -- Chakra: Chastise
	[81206]  = not legion_700, -- Chakra: Sanctuary
	[81208]  = not legion_700, -- Chakra: Serenity
	[47585]  = true, -- Dispersion
	[123266] = not legion_700, -- Divine Insight (Holy)
	[123267] = not legion_700, -- Divine Insight (Discipline)
	[605]    = true, -- Dominate Mind
	[81661]  = not legion_700, -- Evangelism
	[586]    = true, -- Fade
	[81292]  = not legion_700, -- Glyph of Mind Spike
	[159628] = not legion_700, -- Glyph of Shadow Magic
	[132573] = not legion_700, -- Insanity
	[2096]   = true, -- Mind Vision
	[114239] = true, -- Phantasm
	[10060]  = true, -- Power Infusion
	[123254] = true, -- Twist of Fate
	[63735]  = not legion_700, -- Serendipity
	[15473]  = not legion_700, -- Shadowform
	...
	[155362] = not legion_700, -- Word of Mending
}
self_debuffs.PRIEST = {
	[114216] = not legion_700, -- Angelic Bulwark
	[155274] = not legion_700, -- Saving Grace
}
pet_buffs.PRIEST = {}
enemy_debuffs.PRIEST = {
	[2944]   = not legion_700, -- Devouring Plague
	[605]    = true, -- Dominate Mind
	[87194]  = not legion_700, -- Glyph of Mind Blast
...
-- ROGUE
friend_buffs.ROGUE = {
	[115834] = not legion_700, -- Shroud of Concealment
	[113742] = not legion_700, -- Swiftblade's Cunning
...
self_buffs.ROGUE = {
	...
	[121153] = not legion_700, -- Blindside
	...
	[73651]  = not legion_700, -- Recuperate
	[51713]  = not legion_700, -- Shadow Dance
	[36554]  = true, -- Shadowstep
	[114018] = not legion_700, -- Shround of Concealment
...
enemy_debuffs.ROGUE = {
	...
	[91023]  = not legion_700, -- Find Weakness
	[703]    = true, -- Garrote
	[1330]   = true, -- Garrote - Silence
	[1776]   = true, -- Gouge
	[16511]  = true, -- Hemorrhage
	[408]    = true, -- Kidney Shot
	[84617]  = not legion_700, -- Revealing Strike
	[1943]   = true, -- Rupture
	[6770]   = true, -- Sap
	[79140]  = true, -- Vendetta
...
friend_buffs.SHAMAN = {
	...
	[974]    = not legion_700, -- Earth Shield
	[4057]   = true, -- Fire Resistance
	[4077]   = true, -- Frost Resistance
	[116956] = not legion_700, -- Grace of Air
	[8178]   = true, -- Grounding Totem Effect
	[73920]  = true, -- Healing Rain
	[119523] = not legion_700, -- Healing Stream Totem (Glyph of Healing Stream Totem)
...
self_buffs.SHAMAN = {
	...
	[16166]  = not legion_700, -- Elemental Mastery
	[6196]   = true, -- Far Sight
	[2645]   = true, -- Ghost Wolf
	[324]    = not legion_700, -- Lightning Shield
	[53817]  = not legion_700, -- Maelstrom Weapon
	[16188]  = not legion_700, -- Nature's Swiftness
	[30823]  = not legion_700, -- Shamanistic Rage
	[98007]  = true, -- Spirit Link Totem
	[115356] = true, -- Stormblast
	[53390]  = true, -- Tidal Waves
	[52127]  = not legion_700, -- Water Shield
...
enemy_debuffs.SHAMAN = {
	...
	[8050]   = not legion_700, -- Flame Shock
	[63685]  = not legion_700, -- Freeze (Frozen Power)
	[8056]   = not legion_700, -- Frost Shock
...
friend_buffs.WARLOCK = {
	[166928] = not legion_700, -- Blood Pact
	[109773] = not legion_700, -- Dark Intent
...
self_buffs.WARLOCK = {
	...
	[111397] = not legion_700, -- Blood Horror
	[111400] = true, -- Burning Rush
	[110913] = not legion_700, -- Dark Bargain
	[108359] = true, -- Dark Regeneration
	[113858] = not legion_700, -- Dark Soul: Instability
	[113861] = not legion_700, -- Dark Soul: Knowledge
	[113860] = not legion_700, -- Dark Soul: Misery
	[157695] = true, -- Demonbolt
	[88448]  = true, -- Demonic Rebirth
	[171982] = true, -- Demonic Synergy
	[126]    = true, -- Eye of Kilrogg
	[108683] = not legion_700, -- Fire and Brimstone
	[120451] = not legion_700, -- Flames of Xoroth
	[108503] = true, -- Grimoire of Sacrifice
	[755]    = true, -- Health Funnel
	[6262]   = true, -- Healthstone (Glyph of)
	[1949]   = not legion_700, -- Hellfire
	[104025] = not legion_700, -- Immolation Aura
	[137587] = not legion_700, -- Kil'jaeden's Cunning
	[1454]   = true, -- Life Tap (Glyph of)
	[108508] = not legion_700, -- Mannoroth's Fury
	[103958] = not legion_700, -- Metamorphosis
	[122355] = not legion_700, -- Molten Core
	[108416] = true, -- Sacrificial Pact
	[17941]  = true, -- Shadow Trance
	[74434]  = not legion_700, -- Soulburn
	[79438]  = not legion_700, -- Soulburn: Demonic Circle
	[86211]  = true, -- Soul Swap
	[101976] = not legion_700, -- Soul Harvest
	[104773] = true, -- Unending Resolve
}
self_debuffs.WARLOCK = {
	[110914] = not legion_700, -- Dark Bargain
}
pet_buffs.WARLOCK = {
...
enemy_debuffs.WARLOCK = {
	[85387]  = not legion_700, -- Aftermath
	[980]    = true, -- Agony
	[89766]  = true, -- Axe Toss (Felguard)
	[710]    = true, -- Banish
	[137143] = not legion_700, -- Blood Horror
	[124915] = not legion_700, -- Chaos Wave
	...
	[603]    = true, -- Doom
	[689]    = true, -- Drain Life
	[103103] = not legion_700, -- Drain Soul
	[5782]   = true, -- Fear
	[48181]  = true, -- Haunt
	[80240]  = true, -- Havoc
	...
	[47960]  = not legion_700, -- Hand of Gul'dan
...
friend_buffs.WARRIOR = {
	[6673]   = not legion_700, -- Battle Shout
	[469]    = not legion_700, -- Commanding Shout
	[3411]   = true, -- Intervene
	[114029] = not legion_700, -- Safeguard
...
self_buffs.WARRIOR = {
	[107574] = true, -- Avatar
	[2457]   = not legion_700, -- Battle Stance
	[18499]  = true, -- Berserker Rage
	[46924]  = true, -- Bladestorm
	[12292]  = true, -- Bloodbath
	[46916]  = not legion_700, -- Bloodsurge
	[71]     = true, -- Defensive Stance
	[125565] = true, -- Demoralizing Shout
	[118038] = true, -- Die by the Sword
	[12880]  = not legion_700, -- Enrage
	[55694]  = not legion_700, -- Enraged Regeneration
	[156291] = not legion_700, -- Gladiator Stance
	[133278] = not legion_700, -- Heroic Leap (Glyph of)
	[12975]  = true, -- Last Stand
	[114028] = true, -- Mass Spell Reflect
	[85739]  = true, -- Meat Cleaver
	[114192] = not legion_700, -- Mocking Banner
	[12294]  = true, -- Mortal Strike (Glyph of)
	[131116] = true, -- Raging Blow
	[115317] = not legion_700, -- Raging Wind
	[1719]   = true, -- Recklessness
	[125667] = not legion_700, -- Second Wind
	[112048] = not legion_700, -- Shield Barrier
	[2565]   = true, -- Shield Block
	[169667] = not legion_700, -- Shield Charge
	[871]    = true, -- Shield Wall
	[23920]  = true, -- Spell Reflection
	[52437]  = true, -- Sudden Death
	[12328]  = not legion_700, -- Sweeping Strikes
	[152277] = true, -- Ravager
...
enemy_debuffs.WARRIOR = {
	...
	[105771] = true, -- Charge
	[86346]  = not legion_700, -- Colossus Smash
	[1604]   = true, -- Dazed
	[115768] = true, -- Deep Wounds
	[1160]   = true, -- Demoralizing Shout
	[118895] = not legion_700, -- Dragon Roar
	[1715]   = true, -- Hamstring
	[5246]   = true, -- Intimidating Shout
	[115804] = true, -- Mortal Wounds
	[12323]  = true, -- Piercing Howl
	[64382]  = not legion_700, -- Shattering Throw
	[132168] = true, -- Shockwave
	[176289] = true, -- Siegebreaker
	[18498]  = not legion_700, -- Silenced - Gag Order
	[129923] = not legion_700, -- Sluggish (Glyph of Hindering Strikes)
...
-- TODO: Transcendence
friend_buffs.MONK = {
	[132120] = not legion_700, -- Enveloping Mist
	[119611] = true, -- Renewing Mist
	[115921] = not legion_700, -- Legacy of the Emperor
	[116781] = not legion_700, -- Legacy of the White Tiger
...
self_buffs.MONK = {
	...
	[118864] = not legion_700, -- Combo Breaker: Tiger Palm
	[122278] = true, -- Dampen Harm
	[121125] = not legion_700, -- Death Note
	[122783] = true, -- Diffuse Magic
	[115308] = true, -- Elusive Brew
	[115288] = true, -- Energizing Brew
	[120954] = true, -- Fortifying Brew
	[115295] = not legion_700, -- Guard
	[124273] = true, -- Heavy Stagger
	[124275] = true, -- Light Stagger
	[115867] = not legion_700, -- Mana Tea
	[124274] = true, -- Moderate Stagger
	[119085] = true, -- Momentum
	[124968] = not legion_700, -- Retreat (Glyph of)
	[127722] = not legion_700, -- Serpent's Zeal
	[115307] = not legion_700, -- Shuffle (Brewmaster Training)
	[116705] = true, -- Spear Hand Strike
	[107270] = true, -- Spinning Crane Kick
	[124255] = true, -- Stagger
	[116680] = true, -- Thunder Focus Tea
	[116740] = true, -- Tigereye Brew
	[125359] = not legion_700, -- Tiger Power
	[120273] = not legion_700, -- Tiger Strikes
	[125174] = true, -- Touch of Karma
	[118674] = not legion_700, -- Vital Mists
