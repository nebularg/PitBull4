...
},
{
	...
	filters = {
		...
		[',,0'] = {
			display_name = L["Demon Hunter self buffs"],
			filter_type = 'Name',
			whitelist = true,
		...
		[',,2'] = {
			display_name = L["Demon Hunter friend buffs"],
			filter_type = 'Name',
			whitelist = true,
		...
		[',,6'] = {
			display_name = L["Demon Hunter enemy debuffs"],
			filter_type = 'Name',
			whitelist = true,
		...
		-- [',,5'] = {
		-- 	display_name = L["Demon Hunter friend debuffs"],
		-- 	filter_type = 'Name',
		-- 	whitelist = true,
		-- 	name_list = enemy_debuffs.DEMONHUNTER,
		-- 	built_in = true,
		...
		-- [',,4'] = {
		-- 	display_name = L["Demon Hunter self debuffs"],
		-- 	filter_type = 'Name',
		-- 	whitelist = true,
		-- 	name_list = enemy_debuffs.DEMONHUNTER,
		-- 	built_in = true,
		...
		[',,7'] = {
			display_name = L["Demon Hunter can purge"],
			filter_type = 'Aura Type',
			whitelist = true,
